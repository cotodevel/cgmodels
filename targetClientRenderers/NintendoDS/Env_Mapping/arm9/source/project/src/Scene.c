...
void setupTGDSProjectOpenGLDisplayLists(){
	...
	//Update custom texture attributes for a given texture name
	cafe_texid = texturesInSlot - 1;
	glTexImage2D( cafe_texid, 0, GL_RGB, TEXTURE_SIZE_128 , TEXTURE_SIZE_128, 0, GL_TEXTURE_WRAP_S|GL_TEXTURE_WRAP_T|TEXGEN_NORMAL, (u8*)cafe );
